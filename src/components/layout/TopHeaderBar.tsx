...
export const TopHeaderBar: React.FC<TopHeaderBarProps> = ({
  ...
  return (
    <div className="h-11 px-3 bg-[#fbfbfb] dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between select-none z-40 transition-colors">
      {/* Left: Logo & Branding */}
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex flex-col justify-center">
          <span className="font-bold text-xs md:text-sm text-slate-800 dark:text-slate-100 leading-tight tracking-tight">
            {t('appTitle', language)}
          </span>
